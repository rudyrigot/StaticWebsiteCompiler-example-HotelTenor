...
woff = path + "/webfonts/woff/style_183117.woff";
if (http) {
...
//test for eot
eot = path + "/webfonts/eot/style_183117.eot";
if (http) {
	xmlhttp=new XMLHttpRequest();
}
else {
...
//test for svg
svg = path + "/webfonts/svg/style_183117.svg";
if (http) {
	xmlhttp=new XMLHttpRequest();
}
else {
...
//test for css
css = path + "/webfonts/datacss/MuseoTenor.css";
if (http) {
	xmlhttp=new XMLHttpRequest();
}
else {
